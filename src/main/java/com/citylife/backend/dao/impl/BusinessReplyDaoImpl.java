 ...
 */
@Repository
public class BusinessReplyDaoImpl extends BaseDaoImpl<BusinessReply, String> implements BusinessReplyDao {

	@Override
	public List<BusinessReply> findList(String commentId, int size, int page) {
		...
		return mongoTemplate.find(query, BusinessReply.class);
	}
