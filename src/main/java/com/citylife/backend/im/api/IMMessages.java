...
public class IMMessages {
	...
	private static Logger LOGGER = LoggerFactory.getLogger(IMMessages.class);
	...
	public static ObjectNode getUserStatus(String targetUserPrimaryKey) {
		...
		try {
			...
			URL userStatusUrl = HTTPClientUtils.getURL(Constants.APPKEY.replace("#", "/") + "/users/" + targetUserPrimaryKey + "/status");
