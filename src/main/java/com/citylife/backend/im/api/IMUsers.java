...
//	}
	...
	public static void main(String[] args) {
		...
		/////////////////用户登录///////////////////////
//		String ownerUserPrimaryKey = "test1";
//		String password = "123";
//		imUserLogin(ownerUserPrimaryKey, password); 
		
		/////////////////注册单个用户////////////////////
		ObjectNode objectNode = factory.objectNode();
		objectNode.put("username", "test11");
		objectNode.put("password", "123");
		createNewIMUserSingle(objectNode);
		
		///////// 根据用户ID获取用户//////////
		//getIMUsersByPrimaryKey("test5"); 
		//getIMUsersByPrimaryKey("d46321aa-511f-11e4-957b-0f419d103181");  
		
		///////// 删除用户//////////
//		deleteIMUserByUserPrimaryKey("test4"); 
